  ...
  return (
    <div className="w-100">
      ...
      <div className="page-header">
        <div>
          <h3>
            <i className="bi bi-box-seam-fill" style={{ color: 'var(--ph-gold-dark)' }}></i>
            Stock Intake &amp; Barcode Scanner
          </h3>
          <p>Scan via camera, upload a barcode photo, or enter barcode manually</p>
        </div>
      ...
      <div className="ph-card">
        <div className="ph-card-header" style={{ paddingBottom: 0 }}>
          <h5 style={{ fontSize: '1.05rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 8, margin: 0 }}>
            <i className="bi bi-card-checklist" style={{ color: 'var(--ph-gold-dark)' }}></i>
